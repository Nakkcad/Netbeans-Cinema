...
import model.ScreeningSchedule;
    /**
    * ViewByDateDialog class provides an interface for viewing screening schedules filtered by date.
    * It allows administrators to enter a specific date and view all associated screening schedules.
    * @author hp
    */
public class ViewByDateDialog extends javax.swing.JDialog {
    private ScreeningScheduleDAO screeningScheduleDAO;
    /**
     * Constructs a ViewByDateDialog with the specified parent frame.
     * Initializes components and the screening schedule DAO.
    ...
    /**
     * Loads screening schedules for the specified date.
     ...
     * Loads schedules for the specified date.
