...
import model.ScreeningSchedule;
    /**
    * EditScheduleDialog class provides an interface for editing existing screening schedules.
    * It allows administrators to modify film, screen, date, and time information for a schedule.
    * @author hp
     */
public class EditScheduleDialog extends javax.swing.JDialog {
    ...
    /**
     * Constructs an EditScheduleDialog with the specified parent frame and schedule ID.
     * Initializes components and loads the schedule data.
    ...
    /**
     * Loads the schedule data into the form.
     * Retrieves the schedule from the database and populates the form fields.
     */
     ...
     * Validates input, creates a new schedule object, and updates the database.
